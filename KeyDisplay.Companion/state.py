...
class InputState:
    __slots__ = ("keys", "mouse", "mx", "my", "seq")
    ...
    def serialize(self):
        return struct.pack("<4sBHBiiI", MAGIC, VERSION, self.keys,
                           self.mouse, self.mx, self.my, self.seq)
...
def parse_snapshot(data):
    ...
    magic, ver, keys, mouse, mx, my, seq = struct.unpack("<4sBHBiiI", data)
    if magic != MAGIC or ver != VERSION:
        return None
    return {"keys": keys, "mouse": mouse, "mx": mx, "my": my, "seq": seq}